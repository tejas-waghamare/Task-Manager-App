        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Track your daily work progress and history</p>
            </div>
          </div>
      ...
      <div className="p-6">
        {filteredReports.length === 0 ? (
          <div className="text-center py-12">
            ...
            {!searchTerm && !filterDate && (
              <button
                onClick={() => window.location.href = '/employee/dashboard?tab=submit-report'}
          ...
          <>
            <div className="space-y-4">
              {currentReports.map((report, index) => (
                <div
                  key={report._id}
                  className="group bg-white border border-gray-200 rounded-xl hover:shadow-lg hover:border-purple-200 transition-all duration-300 overflow-hidden"
                  style={{
