      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <div className="flex flex-col items-center justify-center space-y-4">
          <div className="relative">
            ...
            <div className="absolute top-0 left-0 w-16 h-16 border-4 border-cyan-500 rounded-full animate-spin border-t-transparent"></div>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <div className="w-6 h-6 bg-cyan-700 rounded-full animate-pulse"></div>
            </div>
          </div>
          ...
          <p className="text-gray-500 text-sm animate-pulse">Loading All Employees...</p>
        </div>
      </div>
                      ...
                      stats.tasks.map((task, idx) => (
                        <div key={idx} className="bg-gray-50 rounded-xl p-3">
                          <div className="flex justify-between items-start">
                            ...
                            <span className={`px-2 py-1 text-xs rounded-full ${task.status === 'completed' ? 'bg-green-100 text-green-700' :
