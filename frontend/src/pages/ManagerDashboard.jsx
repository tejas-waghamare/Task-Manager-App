        ...
        {activeTab === 'overview' && (
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                <h1 className="text-4xl font-bold p-1 bg-gradient-to-r from-cyan-700 to-gray-600 bg-clip-text text-transparent">
                  Manager's Dashboard
                </h1>
                <p className="text-gray-500 p-1 flex items-center">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow duration-300">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      ...
                      className="group relative overflow-hidden cursor-pointer bg-gradient-to-r from-blue-600 to-blue-500 text-white px-4 py-3 rounded-xl hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5"
                    >
                    ...
                    <button
                      ...
                      className="group relative overflow-hidden cursor-pointer bg-gradient-to-r from-green-600 to-green-500 text-white px-4 py-3 rounded-xl hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5"
                    >
                      <div className="relative z-10 flex items-center justify-center space-x-2">
