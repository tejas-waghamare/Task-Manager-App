...
//       className={`group flex items-center cursor-pointer space-x-2 py-2.5 px-4 rounded-xl transition-all duration-200 ${
//         activeTab === id
...
//                 </span>
//                 <h1 className="text-4xl p-1 font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
//                   {getGreeting()}
//                 </h1>
//               </div>
...
//                       <button
//                         onClick={() => setActiveTab('submit-report')}
//                         className="ml-4 bg-gradient-to-r from-indigo-600 to-blue-600 text-white px-5 py-2.5 rounded-xl cursor-pointer hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 font-medium whitespace-nowrap"
//                       >
